...
export default function SearchIdCategory({params}) {
  const [idCategoty, setIdCategoty] = useState([params.id])
  console.log("params " + idCategoty)
    return (
        <>
      <HeroSearch />
      <FormSearch />
