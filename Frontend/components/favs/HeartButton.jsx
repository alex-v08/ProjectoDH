...
const HeartButton = ({fillColor, behaivour}) => {
    const [isFav, setIsFav] = useState(false);

    const { user } = useAuth;

    // const hostUrl = process.env.NEXT_PUBLIC_USER_URL;
    // const urlAddFav = `${hostUrl}/api/favorites/add`

    // try {
    //     const response = fetch(urlAddFav, {
    //       method: 'POST',
    //       headers: {
    ...
    //   } catch (error) {
    //     console.error(
    //       'Error al intentar agregar el producto a favoritos:',
    //       error
    //     )
    //   }
